...
This Laravel >= 5.5 package allows you to add a visit counter to your visitable Eloquent models.
...
* Queue the visits before storing them to prevent slow requests
...
This package requires [PHP](https://php.net/) v7+ and [Laravel](https://laravel.com/) 5.5+.
